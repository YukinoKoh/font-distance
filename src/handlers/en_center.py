...
def insert_en():
    ...
    design = 'Google'
    insertEn(name, category, width, w_width, x_height, m_serif, h_stem_horizontal_balance, o_stroke_axis, p_decender, i_line_thickness, design)
...
def insertEn(name, category, width, w_width, x_height, m_serif, h_stem_horizontal_balance, o_stroke_axis, p_decender, i_line_thickness, design):
